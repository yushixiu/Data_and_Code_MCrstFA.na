#Table1
bic_1=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/bic1_msl.txt', sep=''), sep='')[,-1])
icl_1=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/icl1_msl.txt', sep=''), sep='')[,-1])
ari_1=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ari1_msl.txt', sep=''), sep='')[,-1])
ccr_1=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ccr1_msl.txt', sep=''), sep='')[,-1])
mspe_1=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/mspe1_msl.txt', sep=''), sep='')[,-1])
bic_2=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/bic2_msl.txt', sep=''), sep='')[,-1])
icl_2=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/icl2_msl.txt', sep=''), sep='')[,-1])
ari_2=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ari2_msl.txt', sep=''), sep='')[,-1])
ccr_2=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ccr2_msl.txt', sep=''), sep='')[,-1])
mspe_2=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/mspe2_msl.txt', sep=''), sep='')[,-1])
bic_3=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/bic3_msl.txt', sep=''), sep='')[,-1])
icl_3=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/icl3_msl.txt', sep=''), sep='')[,-1])
ari_3=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ari3_msl.txt', sep=''), sep='')[,-1])
ccr_3=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ccr3_msl.txt', sep=''), sep='')[,-1])
mspe_3=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/mspe3_msl.txt', sep=''), sep='')[,-1])
bic_4=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/bic4_msl.txt', sep=''), sep='')[,-1])
icl_4=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/icl4_msl.txt', sep=''), sep='')[,-1])
ari_4=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ari4_msl.txt', sep=''), sep='')[,-1])
ccr_4=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/ccr4_msl.txt', sep=''), sep='')[,-1])
mspe_4=as.matrix(read.table(paste(WD.PATH, 'results/Sim1_TabFig/mspe4_msl.txt', sep=''), sep='')[,-1])
...
table2=cbind(tab_mis10,tab_mis20,tab_mis30,tab_mis40)
table2
