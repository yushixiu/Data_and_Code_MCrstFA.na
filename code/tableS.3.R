...
PATH=paste(WD.PATH, 'results/Sim2_TableS.3(r=20)/', sep='')
miss.rate=0.2
...
table.s3=list(tab1,tab2)
file_path=paste(WD.PATH, 'results/TableS.3.csv', sep='')
capture.output(table.s3, file=file_path)
