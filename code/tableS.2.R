...
PATH=paste(WD.PATH, 'results/Sim2_TableS.2(r=10)/', sep='')
miss.rate=0.1
...
table.s2=list(tab1,tab2)
file_path=paste(WD.PATH, 'results/TableS.2.csv', sep='')
capture.output(table.s2, file=file_path)
