...
PATH=paste(WD.PATH, 'results/Sim2_TableS.1(r=0)/', sep='')
miss.rate=0
...
table.s1=list(tab1,tab2)
file_path=paste(WD.PATH, 'results/TableS.1.csv', sep='')
capture.output(table.s1, file=file_path)
