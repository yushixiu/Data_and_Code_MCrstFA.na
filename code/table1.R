...
source(paste(WD.PATH, 'function/Sim1tab1.R', sep=''))
...
row.names(tab_mis10)=c('BIC','BIC(sd)','BIC(freq)','ICL','ICL(sd)','ICL(freq)','ARI','ARI(sd)','ARI(freq)','CCR','CCR(sd)','CCR(freq)','MSPE','MSPE(sd)','MSPE(freq)')
...
row.names(tab_mis20)=c('BIC','BIC(sd)','BIC(freq)','ICL','ICL(sd)','ICL(freq)','ARI','ARI(sd)','ARI(freq)','CCR','CCR(sd)','CCR(freq)','MSPE','MSPE(sd)','MSPE(freq)')
...
row.names(tab_mis30)=c('BIC','BIC(sd)','BIC(freq)','ICL','ICL(sd)','ICL(freq)','ARI','ARI(sd)','ARI(freq)','CCR','CCR(sd)','CCR(freq)','MSPE','MSPE(sd)','MSPE(freq)')
table1=cbind(tab_mis10,tab_mis20,tab_mis30)
