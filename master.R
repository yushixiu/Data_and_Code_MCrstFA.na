...
# Re-produce Experiment 1 results: Figure 2 & Table 1, Table 2
m=100
...
# Re-produce real data (Automobile dataset) results: Table 3, Figure 3, Figure 4, Figure 5, Figure 6
...
# Re-produce real data (CKD dataset) results: Table 5, Table 6, Table 7, Table 8, Figure 7, Figure 8
source(paste(WD.PATH, 'code/table5.R', sep=''))
source(paste(WD.PATH, 'code/table6.R', sep=''))
source(paste(WD.PATH, 'code/table7.R', sep=''))
source(paste(WD.PATH, 'code/table8.R', sep=''))
